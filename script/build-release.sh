...
nasm -Wall -f bin -o ./out/floppyboot.bin ./src/floppyboot.S

echo "Building stage2..."
nasm -Wall -f bin -o ./out/OSLOADER.BIN ./src/osloader.S

echo "Building BOOTTEST.BIN"
nasm -Wall -f bin -o ./out/BOOTTEST.BIN ./src/miniboot/boot32.S
